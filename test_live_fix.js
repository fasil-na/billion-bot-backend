...
const candles = [
  ...
  { time: 5000, open: 72600, high: 72600, low: 72500, close: 72500 }, // c3 (15:53)
];

// Event 1: 15:54 tick arrives
console.log("Event 1 (15:54 forming, 15:53 closed):");
let candles1 = [...candles, { time: 6000, open: 72500, high: 72550, low: 72400, close: 72500 }];
console.log(strategy.checkSignal(candles1, { type: 'live_signal', riskAmount: 100 }).matched); // should be TRUE

// Event 2: 15:55 tick arrives (15:54 closed)
console.log("Event 2 (15:55 forming, 15:54 closed):");
let candles2 = [...candles1, { time: 7000, open: 72500, high: 72550, low: 72400, close: 72500 }];
console.log(strategy.checkSignal(candles2, { type: 'live_signal', riskAmount: 100 }).matched); // should be FALSE now!
